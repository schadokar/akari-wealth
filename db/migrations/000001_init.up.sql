...
CREATE TABLE entity_types (
    ...
    name     TEXT    NOT NULL CHECK (name IN (
                 ...
                 'EQUITY','DEBT','COMMODITY', 'SILVER', 'OIL', 'MF', 'STOCK'
             )),
...
CREATE TABLE entities (
    ...
    type       TEXT NOT NULL, -- EQUITY, DEBT, COMMODITY
    subtype    TEXT NOT NULL, -- MF, STOCK, GOLD, SILVER
...
CREATE TABLE transactions (
    ...
    type          TEXT    NOT NULL CHECK (type IN (
                      'DEBIT', 'CREDIT', 'BUY','SELL','DEPOSIT','WITHDRAWAL','EXPENSE','TRANSFER'
                  )),
    amount        NUMERIC NOT NULL,
    note          TEXT,
